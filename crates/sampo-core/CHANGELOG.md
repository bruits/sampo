...
- [785c986](https://github.com/bruits/sampo/commit/785c98662a61a204fc43252cb227a1bd2de5e487) Fixed `packages.fixed` group members being silently released at different bump levels when another changeset or a `packages.linked` group raised one of them. — Thanks @goulvenclech!
...
- [e16b737](https://github.com/bruits/sampo/commit/e16b737412f4159d11b22c5836eba394a4f12f5a) Added `--bump` / `-b` and `--tag` / `-t` flags to `sampo add`, enabling fully non-interactive changeset creation when combined with `--package` and `--message`:
...
- [f2b24a1](https://github.com/bruits/sampo/commit/f2b24a17c8241ebc78772e69d76c8922ad474c91) Improved error consistency by unifying missing-manifest errors across all ecosystem adapters. — Thanks @goulvenclech!
