...
impl Config {
    ...
    pub fn load(root: &Path) -> Result<Self, SampoError> {
        ...
        let changelog_tags = changelog_table
...
mod tests {
    ...
    fn defaults_when_missing() {
        ...
        assert!(config.changelog_tags.is_empty());
